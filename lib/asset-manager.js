...
AssetManager = (function() {
  ...
  AssetManager.prototype.load = function(fileUri, options) {
    var deferred, extension, fetchOptions, file, filename, keepRawData, loadedResource, parentUri, parseOptions, parserPromise, resource, store, storeName, storeNotFoundError, transient, _ref, _ref1;
    options = options || {};
