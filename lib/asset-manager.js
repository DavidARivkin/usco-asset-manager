...
AssetManager = (function() {
  ...
  AssetManager.prototype.load = function(fileUri, options) {
    var deferred, extension, fetchOptions, file, fileOrFileName, filename, inputDataType, keepRawData, loadedResource, parentUri, parseOptions, parser, parserNotFoundError, rawDataDeferred, resource, store, storeName, storeNotFoundError, transient, _ref, _ref1;
    options = options || {};
